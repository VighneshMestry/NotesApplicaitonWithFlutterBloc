...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({required String email, required String password}) {
    ...
    final user = AuthUser(id: _user!.id,email : 'mestryvighnesh27@gmail.com', isEmailVerified: false);
    _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    final newUser = AuthUser(id:_user!.id, email: 'mestryvighnesh27@gmail.com', isEmailVerified: true);
    _user = newUser;
  }
